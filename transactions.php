...
//search results
$collect = "SELECT * FROM students ORDER BY id desc";
$queryresult = mysqli_query($conn,$collect);
  $query = mysqli_fetch_array($queryresult);
...
if(isset($_GET['type']) && $_GET['type']!=''){
  ...
  if($type=='status'){
    ...
    $updsucc = mysqli_query($conn,$update_status_sql);
    if($updsucc){
  ...
  if($type=='delete'){
    ...
    $delsucc  = mysqli_query($conn,$delete_sql);
...
<!-- Modal Form-->
      ...
      <div class="row gy-4">
            ...
            if(isset($_GET['search'])){
              ...
              <tr>
                ...
                echo "<a class='btn btn-sm btn-success' href='payment.php?id=".$items['id']."'><i class='fa fa-print'></i></a>&nbsp;";
  ...
  No records found for <?php echo $_GET['search']?>
</div></td>
                </tr>
...
$total = $rowc['price'];
$all = $row['firstly']+$row['secondly']+$row['thirdly']+$row['fourthly']+$row['fifthly']+$row['discount'];
$bal = $total - $all;
              ...
              <tr>
                 ...
                 <td class="border-bottom-0"><?php echo $row['firstly']?></td>
                 <td class="border-bottom-0"><?php echo $row['secondly']?></td>
                 <td class="border-bottom-0"><?php echo $row['thirdly']?></td>
                 <td class="border-bottom-0"><?php echo $row['fourthly']?></td>
                 <td class="border-bottom-0"><?php echo $row['fifthly']?></td>
                 <td class="border-bottom-0"><?php echo $row['discount']?></td>
                ...
                echo "<a class='btn btn-sm btn-success' href='payment.php?id=".$row['id']."'><i class='fa fa-edit'></i></a>&nbsp;";
                echo "<a class='btn btn-sm btn-success' href='payment.php?id=".$row['id']."'><i class='fa fa-print'></i></a>&nbsp;";
