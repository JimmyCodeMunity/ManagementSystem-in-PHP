...
if(isset($_POST['submit'])){
  ...
  $update = "UPDATE userdata SET username ='$uname',phone = '$phone',email ='$email' WHERE id='$id'";
  $result = mysqli_query($conn,$update);

  if($result){
    $error[] = 'admin data updated successfully';
  echo '<meta http-equiv="refresh" content="0">';
  header('loacation:forms.php');

  }
  else{
    $error[] = 'admin update failure!!';
...
<?php @include('sidebar.php')?>
      ...
      ?>
                  <div class="card-header">
                    <h3 class="h4 mb-0">Update Admin details</h3>
                  </div>
                  <div class="card-body pt-0">
                    ...
                    <form action="" method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="exampleInputEmail1" type="text" name="uname" aria-describedby="emailHelp" value="<?php echo $row['username']?>">
                    ...
                    <div class="row">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="exampleInputEmail1" name="phone" type="text" aria-describedby="emailHelp" value="<?php echo $row['phone']?>">
                                              </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="exampleInputEmail1" type="text" aria-describedby="emailHelp" name="email" value="<?php echo $row['email']?>">
                  ...
                  <div class="card-body pt-0">
                    ...
                    <form action="" method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="exampleInputEmail1" type="password" name="pass" aria-describedby="emailHelp" value="">
                    ...
                    <div class="row">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="exampleInputEmail1" name="cpass" type="Password" aria-describedby="emailHelp" value="">
                                              </div>
                    </div>
                  </div>
                      ...
                      <button class="btn btn-primary" type="submit" name="passchange">Confirm</button>
