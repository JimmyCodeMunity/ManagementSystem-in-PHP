...
$total = $rowc['price'];
              ...
              <tr>
                ...
                echo "<a class='btn btn-sm btn-primary' href='upload.php?id=".$row['id']."'><i class='fa fa-upload'></i>Upload</a>&nbsp;";

                echo "<a class='btn btn-sm btn-primary' href='upload.php?id=".$row['id']."'><i class='fa fa-eye'></i>View</a>&nbsp;";
