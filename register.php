...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = "INSERT INTO userdata(username, email, phone, password) VALUES('$name','$email','$mobile','$pass')";
  ...
  <div class="content-container">
    <div class="form-container">
      ...
      ?>
        ...
        <br>
        <p>already have an acount? <a href="index.php">Login</a> </p>
      </form>
    </div>
  </div>
</div>
