...
if(isset($_POST['submit'])){
  ...
  $update = "UPDATE students SET firstname ='$fname',lastname ='$lname',phone = '$sphone',parent ='$parent',p_phone = '$gphone',admission_date='$date',course = '$course',course2 = '$course2' WHERE id='$id'";
  $result = mysqli_query($conn,$update);

  if($result){
    $error[] = 'student data updated successfully';
  echo '<meta http-equiv="refresh" content="0">';
  header('loacation:forms.php');

  }
  else{
    $error[] = 'Student update failure!!';
                  ...
                  <div class="card-body pt-0">
                    ...
                    <div class="row">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="exampleInputEmail1" name="sphone" type="text" aria-describedby="emailHelp" value="<?php echo $row['phone']?>">
                                              </div>
                    </div>
                    <div class="col-lg-5">
                      <div class="mb-3">
                        <label class="form-label" for="exampleInputPassword1">Guardian</label>
                        <input class="form-control" id="exampleInputPassword1" type="text" name="guardian" value="<?php echo $row['parent']?>">
                      </div>
                    </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="exampleInputEmail1" type="text" aria-describedby="emailHelp" name="gphone" value="<?php echo $row['p_phone']?>">
                    ...
                    <div class="col-lg-5">
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="exampleInputPassword1" type="date" name="date" value="<?php echo $row['admission_date']?>">
                      </div>
                    </div>
                    <div class="row">
                    <div class="col-lg-5">
                      <div class="mb-3">
                        <label class="visually-hidden" for="inlineFormSelectPref">Course 1</label>
                        <select class="form-select" id="course" name="course" onchange="updateAmount()">
                          <option for="course" selected><?php echo $row['course']?></option>
                          <?php
                    ...
                    <div class="col-lg-5">
                      <div class="mb-3">
                        <label class="" for="inlineFormSelectPref">Course 2</label>
                        <select class="form-select" id="course2" name="course2" onchange="updateAmount()">
                          <option for="course2" selected><?php echo $row['course2']?></option>
                          <?php
                          $servsel = "SELECT * FROM courses";
                          $sel = mysqli_query($conn,$servsel);
                          while($row = $sel->fetch_assoc()){
                            $cn++;
                            ?>
                            <option for="service2"><?php echo $row['coursename']?></option>
                            <?php } ?>
